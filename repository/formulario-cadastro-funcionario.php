...
<html lang="pt_BR">
  ...
  <?php include('navbar.php'); ?>
    ...
    <fieldset>
      ...
      <form action="registrafuncionario.php" method="post" class="form" enctype="multipart/form-data">
        <div class="card col-4 offset-4">
          <svg class="bd-placeholder-img card-img-top" width="100%" height="180" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Foto do funcionario" preserveAspectRatio="xMidYMid slice" focusable="false">
            ...
            <rect width="100%" height="100%" fill="#868e96"></rect><text x="20%" y="50%" fill="#dee2e6" dy=".3em">Foto do funcionario</text>
          </svg>
        </div>
        ...
        <div class="mb-3 form-group">
          ...
          <input type="number" name="cpf" id="cpfId" class="form-control" placeholder="Informe o CPF" required>
